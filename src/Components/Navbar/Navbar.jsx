          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              {userToken && <div className="space-y-2 py-6">
                ...
                <NavLink to={'/'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50  after:h-0 ">home</NavLink>
                <NavLink to={'cart'} className="relative block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50  after:h-0 ">
                  cart
                ...
                <NavLink to={'brands'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50  after:h-0 ">brands</NavLink>
                <NavLink to={'categories'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50  after:h-0 ">categories</NavLink>
                <NavLink to={'products'} className="block rounded-lg  text-base/7 font-medium text-gray-900 hover:bg-gray-50  after:h-0 ">products</NavLink>
              </div>}
              <div className="py-6">
                {userToken ?
